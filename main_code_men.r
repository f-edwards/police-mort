...
pop2<-fread("nhgis0029_ds216_20155_2015_county.csv")
...
#          adult.pop=ADURE008+ADURE019)%>%
#   select(fips, black.adult, white.adult, latino.adult, child.pop)

# FOR MEN ONLY

pop<-pop2%>%
  mutate(black=ADT5E007+ADT5E008+ADT5E009+
           ADT5E010+ADT5E011+ADT5E012+ADT5E013+
           ADT5E014+ADT5E015+ADT5E016,
         white=ADUBE007+ADUBE008+ADUBE009+
           ADUBE010+ADUBE011+ADUBE012+ADUBE013+
           ADUBE014+ADUBE015+ADUBE016,
         latino=ADUCE007+ADUCE008+ADUCE009+
           ADUCE010+ADUCE011+ADUCE012+ADUCE013+
           ADUCE014+ADUCE015+ADUCE016,
         tot.pop=ADURE008)%>%
  select(fips, black, white, latino, tot.pop, state)
